...
int main(void) {
    char str1[MAX_CHARS] = "HeLlO tHiS iS a VaLiD sTrInG"; // 12 lowercase letter
    int lowercase_count = count_lowercase(str1);
    printf("Number of lowercase letter: %d\n", lowercase_count);

    char str2[MAX_CHARS] = "i am trying to make a string containing vowel";
    make_vowels_uppercase(str2);
    printf("New string: %s\n", str2);

    char str3[MAX_CHARS] = "This is a very long string hehe";
    delete_following_words(str3);
    printf("New string: %s\n", str3);
